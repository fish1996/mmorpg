/****************************************************************************
** Meta object code from reading C++ file 'handlemsg.h'
**
...
#include "../../client/handlemsg.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'handlemsg.h' doesn't include <QObject>."
...
const QMetaObject handlemsg::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_handlemsg.data,
      qt_meta_data_handlemsg,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *handlemsg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_handlemsg.stringdata0))
        return static_cast<void*>(const_cast< handlemsg*>(this));
