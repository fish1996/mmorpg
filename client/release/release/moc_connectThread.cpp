...
#include "../../client/connectThread.h"
...
QT_MOC_LITERAL(1, 14, 12), // "connectState"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "connectThread\0connectState\0"
};
...
void connectThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->connectState((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (connectThread::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&connectThread::connectState)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject connectThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_connectThread.data,
      qt_meta_data_connectThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void connectThread::connectState(bool _t1)
{
