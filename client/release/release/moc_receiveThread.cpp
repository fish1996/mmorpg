...
#include "../../client/receiveThread.h"
...
QT_MOC_LITERAL(1, 14, 10), // "checkState"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "receiveThread\0checkState\0"
};
...
void receiveThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->checkState((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (receiveThread::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&receiveThread::checkState)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void receiveThread::checkState(bool _t1)
{
